...
func DDDDDDDDDDDDDDDDDDD() {
	defer log.CatchPanic()
	//defer log.InitListner("1")
	log.Printlnlv(2, "WOCOOAOAOOD")
	log.Printlnlv(3, "WOCOOAOAOOD")
	//panic(errors.New("qqqqqqqqqqqqq"))
	DDDDDDDDDDDDDDDDDD()
}
func DDDDDDDDDDDDDDDDDD() {
	//defer log.CatchPanic()
	//defer log.InitListner("1")
	log.Printlnlv(2, "WOCOOAOAOOD")
	log.Printlnlv(3, "WOCOOAOAOOD")
